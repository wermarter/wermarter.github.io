    ...
    projects: [
      {
        ...
        achievements: [
          ...
          "Operated ingestion from crawlers through MySQL and Snowflake.",
        ],
    ...
    projects: [
      {
        ...
        achievements: [
          ...
          "Evolved the architecture from PM2 to Docker, then to multi-node Kubernetes with Envoy Gateway.",
          "Built React workflows, a NestJS gRPC backend, authorization, PDF export, GitOps, storage, and observability.",
        ],
        technologies: ["React", "NestJS", "MongoDB", "Redis", "gRPC", "Kubernetes", "Helm", "Ansible", "Argo CD", "Envoy Gateway"],
        team: "Solo project",
